...
LABEL org.opencontainers.image.title="opencv-face-detection" \
      org.opencontainers.image.description="Production-grade face detection service (YuNet + ONNX Runtime + FastAPI)" \
      org.opencontainers.image.source="https://github.com/chan4kum/opencv-face-detection" \
...
ENV PATH="/app/.venv/bin:${PATH}" \
    ...
    FD_MODEL_PATH=/app/models/face_detection_yunet_2026may.onnx \
    FD_ENVIRONMENT=prod
...
CMD ["uvicorn", "face_detection.api.app:create_app", "--factory", "--host", "0.0.0.0", "--port", "8000", \
